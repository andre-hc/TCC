...
@NamedQueries({
    ...
    , @NamedQuery(name = "Comentario.findFilter", query = "SELECT c FROM Comentario c WHERE c.texto like :filtro or c.usuario.nome like :filtro or c.receita.nome like :filtro")})
