    ...
    <div class="inner">
        ...
        <nav id="menu">
            <ul>
                ...
                <li>
                <center>
                    <a href="../geral/minhaconta.jsp"><img src="../images/user.png" width="100" height="100" alt="Minha conta"></a><br>
                </center>
                </li>
                <%
                    }
                ...
                <li>
                <center>
                    <a href="../geral/minhaconta.jsp"><img src="<%=cabecalho_usuario.getFoto()%>" width="100" height="100" alt="Minha conta"></a>
                </center>
                </li>
                <%
                    }
            ...
            <ul>
                ...
                <li><a href="../geral/minhaconta.jsp">Favoritos</a></li>
            </ul>
        </nav>
