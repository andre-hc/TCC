...
public final class listagemreceita_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if (request.getParameter("idcat") != null) {
        ...
        filtro = 3;
        msg = ingObj.getNome();
        recListIngrediente = recDAO.listarReceitaIngrediente(request.getParameter("iding"));
    } else {
        filtro = 4;
      ...
      out.write("                                    <li><a href=\"../detalhe/receita.jsp?id=");
      out.print(item.getId());
