...
<%
    ...
    List<Ingrediente> ingListAcesso = ingDAO.listarMaisAcessado();
...
//        recObj = recDAO.buscarPorChavePrimaria(Integer.parseInt(request.getParameter("receitaId")));
//    } else {
        ...
        <div id="wrapper">
            ...
            <div id="main">
                <div class="inner">
                    ...
                    <section>
                        <header class="main">
                            <h1><%=recObj.getNome()%></h1>
                        </header>

                        <!-- Content -->
                        <h3>Descrição</h3>
                        <div class="box">
                            <p><%=recObj.getDescricao()%></p>
                        </div>
                        
                                <span class="image fit"><img src="<%=recObj.getImagem1()%>" alt="" /></span>
                                <div class="box alt">
                                    <div class="row 50% uniform">
                                        <div class="4u"><span class="image fit"><img src="<%=recObj.getImagem2()%>" alt="" /></span></div>
                                        <div class="4u"><span class="image fit"><img src="<%=recObj.getImagem3()%>" alt="" /></span></div>
                                        <div class="4u$"><span class="image fit"><img src="<%=recObj.getImagem4()%>" alt="" /></span></div>
                                        <!-- Break -->
                                        <div class="4u"><span class="image fit"><img src="<%=recObj.getImagem5()%>" alt="" /></span></div>
                                    </div>
                                </div>
                ...
                <div class="inner">
                    ...
                    <section>
                        ...
                        <div class="mini-posts">
                            ...
                            %>
                            <article>
                                <a href="#" class="image"><img src="" alt="<%=item.getNome()%>" /></a>
